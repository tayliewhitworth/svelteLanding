    ...
    <div class="mx-auto max-w-screen-xl">
        <div class="md:flex md:justify-between">
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                    <h2 class="mb-6 text-sm font-semibold text-slate-900 uppercase ">Resources</h2>
                ...
                <div>
                    <h2 class="mb-6 text-sm font-semibold text-slate-900 uppercase ">Follow us</h2>
                    <ul class="text-slate-600">
                        <li class="mb-3">
                ...
                <div>
                    <h2 class="mb-6 text-sm font-semibold text-slate-900 uppercase ">Legal</h2>
                    <ul class="text-slate-600">
                        <li class="mb-3">
